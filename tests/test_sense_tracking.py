"""Regression tests for flyohtani/sense/kalman_tracker.py -- prediction
during gaps, the forbidden-channel leak check (same discipline as
tests/test_sense_detection.py), and latency/age behaviour.
"""
...
from flyohtani.sense.kalman_tracker import KalmanBallTracker
...
class TestNoForbiddenChannelLeak:
    ...
    def test_kalman_tracker_never_imports_evaluator_or_world(self):
        source = (REPO_ROOT / "flyohtani" / "sense" / "kalman_tracker.py").read_text()
