...
> **대체됨 (R-01, 2026-09-16):** 이 문서의 완료된 지시/시행착오는 현재 `docs/design/FLY-VISUAL-SPEC.md`로 통합됐다. 코드 주석·다른 문서가 가리키는 이 파일 경로는 그대로 유효하며(역사적 설계 근거), 현재 유효한 규칙은 FLY-VISUAL-SPEC.md에서 확인한다.
