...
| VM-01-B1 | 파리 관절 최소 몸체 설계 | flygym==1.2.1 원본 MJCF 직접 확인(다리당 7 능동 DOF, 위치제어, 질량 단위 규약은 불일치 발견 후 미해결로 명시), 한 앞다리+도구 부착안 제안, 공/도구 크기를 도달거리(0.580m) 기준으로 재설계 — 설계만, 구현 없음 | [설계](../design/VM01-B1-MINIMAL-BODY.md) |
